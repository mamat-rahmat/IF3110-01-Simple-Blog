        ...
        <div class="art-body-inner">
            ...
            <?php
                ...
                while($row = mysql_fetch_array($result)) 
                {
                    ...
                    echo '    <form name="myForm" method="post" action="update_db.php" onsubmit="return validateDate()">';
                    ...
                    echo '        <textarea name="Konten" rows="20" cols="20" id="Konten" value=>'.$row["isi"].'</textarea>';
...
function validateDate() {
    ...
    if (x.match(regex)) {
        ...
        {
            alert("Tanggal harus lebih dari atau sama dengan tanggal sekarang");
            return false;
        }
    ...
    {
        alert("Format tanggal adalah mm/dd/yyyy");
        return false;
    }
}
</script>